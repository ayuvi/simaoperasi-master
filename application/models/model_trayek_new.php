<?php
    class Model_trayek_new extends CI_Model
    {
        public function getAlltrayek($show=null, $start=null, $cari=null, $id_bu)
        {
            ...
            $this->db->where("(a.nm_point_awal  LIKE '%".$cari."%' or a.nm_point_akhir  LIKE '%".$cari."%' ) ");
        ...
        public function getAlltrayek_detail($show=null, $start=null, $cari=null, $id_trayek)
        {
            $this->db->select("a.*");
        ...
        public function get_count_trayek_detail($cari = null, $id_trayek)
        {
            $count = array();
            $session = $this->session->userdata('login');
        ...
        {
            $this->db->insert('ref_trayek_new', $data);
        ...
        public function update_trayek($data)
        {
            ...
            $this->db->where('id_trayek', $data['id_trayek']);
			$this->db->where("active != '2' ");
            $this->db->update('ref_trayek_new', $data);
			return $data['id_trayek'];
        }
