			...
			function testing(id_menu_groups_access){
				...
				if($("#groupakses_"+id_menu_groups_access).is(":checked")){
					...
					jQuery.ajax({
						...
						url: "<?=base_url();?>menu_groups_access/updatecheck/"
					}).done(function(data) {
						console.log(data);
					});
					...
					jQuery.ajax({
						type: "POST",
						data: { id_level: a, id_menu_groups_access: id_menu_groups_access },
						url: "<?=base_url();?>menu_groups_access/updatechecks/"
					}).done(function(data) {
						console.log(data);
					});
				}
            ...
            $('#check-all').on('click', function(e) {
				if($(this).is(':checked',true)) {
                    ...
                    $.ajax({
                        type: "POST",
                        data: {id:list_id},
                        url: "<?php echo site_url('menu_groups_access/updatechecks1/')?>",
                    });
                    ...
                    $.ajax({
                        type: "POST",
                        data: {id:list_id},
                        url: "<?php echo site_url('menu_groups_access/updatecheck1/')?>",
                    });
