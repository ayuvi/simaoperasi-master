...
<table style="border-collapse:collapse;" width="100%" align="center" border="0">
    <tr>
        <td width="22%" align="center" style="font-size:12px;">
            <b>SEGMEN : <?=$data_ms_jadwal['kd_segmen'];?></b><br />
        </td>
...
<table style="border-collapse:collapse;" border="1" width="100%">
    <thead>
        ...
        <tr>
            <td colspan="5" style="font-size:10px;text-align:left;border-right:none;">Jurusan &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp; : <?=$data_ms_jadwal['asal']." - ".$data_ms_jadwal['tujuan'];?></td>
        ...
        <tr>
            <td colspan="5" style="font-size:10px;text-align:left;border-right:none;">KM Tempuh &emsp;&emsp;&emsp;&nbsp; : <?=number_format($data_ms_jadwal['km_tempuh']*$data_ms_jadwal['target'],0,",",".");?> km</td>
        ...
        <tr>
            <td colspan="5" style="font-size:10px;text-align:left;border-right:none;">Driver 1 &emsp;&emsp;&emsp;&emsp;&emsp; : <?=$data_ms_jadwal['pengemudi1'];?></td>
            <td colspan="4"style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="2" style="font-size:10px;text-align:center;"></td>
        ...
        <tr>
            <td colspan="5" style="font-size:10px;text-align:left;border-right:none;">Driver 2 &emsp;&emsp;&emsp;&emsp;&emsp; : <?=$data_ms_jadwal['pengemudi2'];?></td>
            <td colspan="4"style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="2" style="font-size:10px;text-align:center;"></td>
        ...
        <?php
        $nomor = $total_km  = $total_karcis = $total_upp =$total_rit = 0;
        $this->db->select("a.*");
        ...
        <tr>
            ...
            <td style="font-size:10px;text-align:center;"><?=$row->asal;?></td>
            <td style="font-size:10px;text-align:center;"><?=$row->tujuan;?></td>
            <td style="font-size:10px;text-align:center;"><?=intval($row->km_tempuh*$row->target);?></td>
            <td style="font-size:10px;text-align:center;"><?=intval($row->target);?></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"></td>
            <td style="font-size:10px;text-align:center;"><?=intval($row->jum_penumpang*$row->target);?></td>
            <td style="font-size:10px;text-align:right;"><?=number_format(0,0,",",".");?></td>
            <td style="font-size:10px;text-align:right;"><?=number_format(0,0,",",".");?></td>
            <td style="font-size:10px;text-align:right;"><?=number_format($row->upp,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format(0,0,",",".");?></td>
        </tr>
        <?php
        $total_km       +=$row->km_tempuh*$row->target;
        $total_rit      +=$row->target;
        $total_karcis   +=$row->jum_penumpang*$row->target;
        $total_upp      +=$row->upp;
    }?>
    <tr>
    ...
    <tr>
        ...
        <td style="font-size:10px;text-align:center;"><b><?=number_format($total_km,0,",",".");?></b></td></td>
        <td style="font-size:10px;text-align:center;"><b><?=number_format($total_rit,0,",",".");?></b></td></td>
        <td style="font-size:10px;text-align:center;"></td>
        <td style="font-size:10px;text-align:center;"></td>
        <td style="font-size:10px;text-align:center;"></td>
        <td style="font-size:10px;text-align:center;"></td>
        ...
        <td style="font-size:10px;text-align:center;"></td>
        <td style="font-size:10px;text-align:center;"></td>
        <td style="font-size:10px;text-align:right;"><b>Rp. <?=number_format($total_upp,0,",",".");?></b></td></td>
        <td style="font-size:10px;text-align:center;"></td>
    </tr>
    <tr>
        ...
        <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($total_upp,0,",",".");?></td>
    </tr>
    <tr>
        ...
        <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format(0,0,",",".");?></td>
    </tr>
    <tr>
        <td style="font-size:10px;text-align:center;"></td>
        <td colspan="12" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah UPP Penumpang dan Bagasi</b></td>
        <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($total_upp,0,",",".");?></td>
    </tr>
    <tr>
        <td style="font-size:10px;text-align:center;">1</td>
        <td colspan="5" style="font-size:10px;text-align:left;border-right-style:none;">Titipan Asuransi Jasa Raharja (@Rp. <?=number_format(60,0,",",".");?> * Jumlah Karcis)</td>
        <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($ass_jasa_raharja = (0*$total_karcis),0,",",".");?></td>
    </tr>
    <?php
    $nomor_beban_1 = 1;
    ...
    $jml_biaya_titipan=(0*$total_karcis)+$total_beban_1;
    $jml_pnp_dan_upp_bus=$total_upp-$jml_biaya_titipan;
    $jml_upp_kurang_komisi=$jml_pnp_dan_upp_bus;
    ;?>
    <tr>
        <td style="font-size:10px;text-align:center;"></td>
    ...
    <tr>
        ...
        <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format(0,0,",",".");?></td>
    </tr>
    <tr>
        <td style="font-size:10px;text-align:center;"></td>
    ...
    $jml_biaya_langsung = $udj_pengemudi+$total_beban_2;
    $surplus_minus_operasi = $jml_upp_kurang_komisi-$jml_biaya_langsung;
    ;?>
    <tr>
        <td style="font-size:10px;text-align:center;"><?=($nomor_beban+1);?></td>
        <td colspan="5" style="font-size:10px;text-align:left;border-right-style:none;">UDJ Bagasi (10%)</td>
        <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format(0,0,",",".");?> </td>
    </tr>
    <tr>
        <td style="font-size:10px;text-align:center;"><?=($nomor_beban+2);?></td>
        <td colspan="5" style="font-size:10px;text-align:left;border-right-style:none;">UDJ Pengemudi 10% Setelah dikurangi biaya titipan</td>
    ...
    $data_setoran_detail_beban_3 = $this->model_reports_ak13_bor->get_setoran_detail_beban_3($id_setoran);
...
<tr>
    ...
    <td width="33%" align="center" style="font-size:11px;">
        <b><?=strtoupper($cabang_kota)." , ".strtoupper(tgl_indo($tgl_setoran));?></b><br />
