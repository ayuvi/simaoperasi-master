...
//CARI JURUSAN UNTUK WISMA ATLET
$this->db->select("a.kd_trayek");
$this->db->from("ref_setoran_detail a");
$this->db->where('a.id_setoran', $id_setoran);
$this->db->where_in('a.kd_trayek', array("WATL-BSH", "WAK-BSH"));
$wisma = $this->db->get()->num_rows();
$count_wisma = $wisma;
...
<table style="border-collapse:collapse;" border="1" width="100%">
    <thead>
        <tr>
            ...
            <td rowspan="2" colspan="5" style="font-size:10px;text-align:center;">AP/3 Dari UPT No.</td>
        ...
        <tr>
            ...
            <td colspan="5" style="font-size:10px;text-align:center;"></td>
        ...
        <tr>
            ...
            <td colspan="7" style="font-size:10px;text-align:center;">Karcis di Jual Oleh</td>
        ...
        <tr>
            ...
            <td style="font-size:10px;text-align:center;">Kantor Pemasaran</td>
        ...
        <tr>
            ...
            <td style="font-size:10px;text-align:center;background-color:#d5d5e3;"><i>16</i></td>
        </tr>
        <?php
        $nomor = $total_km = $total_rit = $total_karcis = $total_upp_pnp = $total_upp_bagasi = $total_pendapatan = $total_pnp_km = 0;

        $tot_damri_apps = $tot_ota = $tot_agen = $tot_loket = $tot_kantor_pemasaran = $tot_awak_bus = 0;
        $max_rit=array(0);
        ...
        <tr>
            ...
            <td style="font-size:10px;text-align:center;"><?=$row->km_trayek;?></td>
            ...
            <td style="font-size:10px;text-align:center;"><?=$row->kantor_pemasaran;?></td>
            ...
            <td style="font-size:10px;text-align:center;"><?=number_format($row->km_trayek*$row->jumlah,2,",",".");?></td>
        </tr>
        <?php 
        ...
        foreach ($data_setoran_detail_pnp_pertelaan as $row_p) { 
            ...
            $tot_damri_apps     += $row->damri_apps;
            $tot_ota            += $row->ota;
            $tot_agen           += $row->agen;
            $tot_loket          += $row->damri_apps;
            $tot_kantor_pemasaran += $row->kantor_pemasaran;
            $tot_awak_bus       += $row->awak_bus;
            $total_pnp_km   += $row->km_trayek*$row->jumlah;
        }
        ;?>
        <tr>
        ...
        <tr>
            ...
            <td style="font-size:10px;text-align:center;"><b></b></td></td>
            <td style="font-size:10px;text-align:center;"><b><?=number_format(max($max_rit),0,",",".");?></b></td></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_damri_apps,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_ota,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_agen,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_loket,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_kantor_pemasaran,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><?=number_format($tot_awak_bus,0,",",".");?></td>
            <td style="font-size:10px;text-align:center;"><b><?=number_format($total_karcis,0,",",".");?></b></td></td>
            <td style="font-size:10px;text-align:right;"><?=number_format($total_upp_pnp,0,",",".");?></td>
            <td style="font-size:10px;text-align:right;"><?=number_format($total_upp_bagasi,0,",",".");?></td>
            <td style="font-size:10px;text-align:right;"><b>Rp. <?=number_format($total_pendapatan,0,",",".");?></b></td></td>
            <td style="font-size:10px;text-align:center;"><b><?=number_format($total_pnp_km,0,",",".");?></b></td></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;">1</td>
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Total Pendapatan Penumpang</td>
        ...
        <tr>
            ...
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Total Pendapatan Bagasi</td>
        ...
        foreach($query_setoran_detail_pendapatan->result_array() as $row){
            ...
            <tr>
                ...
                <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Pend. <?=$row["keterangan"];?></td>
        ...
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah UPP Penumpang dan Bagasi</b></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($total_pendapatan,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;">1</td>
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Titipan Asuransi Jasa Raharja (@Rp. <?=number_format($asuransi_trayek,0,",",".");?> * Jumlah Karcis)</td>
        ...
        foreach ($data_setoran_detail_beban_1 as $row) {
            ...
            <tr>
                ...
                <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;"><?=$row->nm_komponen;?></td>
        ...
        $jml_upp_kurang_komisi=$jml_pnp_dan_upp_bus-($komisi_agen+$sharing_profit);
        ;?>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah Biaya Titipan</b></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($jml_biaya_titipan,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="10" style="font-size:10px;text-align:left;"><b>Jumlah Penumpang dan UPP Km Bus</b></td>
        ...
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="15" style="font-size:10px;text-align:left;"><b>Biaya Operasi</b></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;">1</td>
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Komisi yang diterima Agen (10%)</td>
            <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($komisi_agen,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;">2</td>
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Sharing Profit(10% dari kantor pemasaran)</td>
            <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($sharing_profit,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;">3</td>
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">Discount/Potongan Harga</td>
            <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: - </td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah Komisi</b></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($jumlah_komisi = $komisi_agen+$sharing_profit,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah UPP Setelah dikurangi Komisi</b></td>
        ...
        foreach ($data_setoran_detail_beban_2 as $row_beban) {
            ...
            <tr>
                ...
                <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;"><?=$row_beban->nm_komponen;?></td>
        ...
        // $udj_bagasi     = $total_upp_bagasi*0.1;
        $udj_bagasi     = $this->model_reports_ak13->udj_bagasi($id_setoran);

        if($count_wisma ==0){
            $udj_pengemudi = ($this->model_reports_ak13->udj_pengemudi($id_setoran,$asuransi_trayek,$id_bu,$total_upp_bagasi,$pend_refund)*0.07);
            $keterangan_udj_pengemudi = "UDJ Pengemudi 7% Setelah dikurangi biaya titipan";
        }else{
            $udj_pengemudi = $jml_upp_kurang_komisi*0.1;
            $keterangan_udj_pengemudi = "UDJ Pengemudi 10% Setelah dikurangi biaya titipan";
        }
        ...
        <tr>
            ...
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;">UDJ Bagasi (10%)</td>
        ...
        <tr>
            ...
            <td colspan="6" style="font-size:10px;text-align:left;border-right-style:none;"><?=$keterangan_udj_pengemudi;?></td>
            <td colspan="9" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($udj_pengemudi,0,",",".");?> </td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah Biaya Langsung</b></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($jml_biaya_langsung,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Surplus/Minus Operasi</b></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;">: Rp. <?=number_format($surplus_minus_operasi,0,",",".");?></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="7" style="font-size:10px;text-align:left;border-right-style:none;"><b>Penerimaan Kembali Titipan</b></td>
        ...
        foreach ($data_setoran_detail_beban_3 as $row) {
            ...
            <tr>
                <td style="font-size:10px;text-align:center;"></td>
                <td colspan="7" style="font-size:10px;text-align:left;border-right-style:none;"><b></b></td>
        ...
        if($id_bu==21){
            $penerimaan_kembali_pph     = $this->model_reports_ak13->sum_komisi_agen($id_setoran)*0.02;
        }else{
        ...
        <tr>
            <td style="font-size:10px;text-align:center;height: 13px"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"></td>
            <td colspan="2" style="font-size:10px;text-align:left;border-left-style:none;"></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Surplus/Minus Operasi dan Jumlah Biaya Titipan</b></td>
        ...
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="15" style="font-size:10px;text-align:left;border-right-style:none;height:15px"></td>
        </tr>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="13" style="font-size:10px;text-align:left;border-right-style:none;"><b>Jumlah Yang Di Setorkan Oleh Awak Bus</b></td>
    ...
    <tbody>
        <tr>
            <td style="font-size:10px;text-align:center;"></td>
            <td colspan="15" style="font-size:10px;text-align:left;"><b></b></td>
        </tr>
    </tbody>
</table>
