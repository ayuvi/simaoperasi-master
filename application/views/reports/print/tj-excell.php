...
<body>
  ...
  <table width="100%" rules="all" border="1" cellpadding="0" cellspacing="0" style="font-size:12px">
    ...
    // AND a.armada IS NOT NULL 
      ...
      <tr>
        ...
        <td style="font-size:12px;text-align:center;"><?=$row->km_empty;?></td>
        <td style="font-size:12px;text-align:right;"><?=$row->km_trayek*$row->harga;?></td>
      </tr>
      <?php
  ...
  <tfoot>
    <tr style="height: 15px">
      ...
      <th style="font-size:12px;text-align:center;"><?=$jml_km;?></th>
      <?php if($count_satu!=0){ ?>
      <th style="font-size:12px;text-align:center;"><?=20;?></th>
      <?php }else { ?>
      <th style="font-size:12px;text-align:center;"><?=0;?></th>
      <?php } ?>
      <th style="font-size:12px;text-align:right;"><?=$jml_total;?></th>
    </tr>
  </tfoot>
</table>
      ...
      <table width="100%" rules="all" border="1" cellpadding="0" cellspacing="0" style="font-size:12px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-size:12px;text-align:center;"><?=$row_b->km_trayek;?></td>
            <td style="font-size:12px;text-align:center;"><?=$row_b->km_empty;?></td>
            <td style="font-size:12px;text-align:right;"><?=$row_b->km_trayek*$row_b->harga;?></td>
          </tr>
          <?php 
        ...
        <tr style="height: 15px">
          <th></th>
          <th align="center" colspan="3">TOTAL</th>
          <th style="font-size:12px;text-align:center;"><?=$jml_km_2;?></th>
          <?php if($count_dua!=0){ ?>
          <th style="font-size:12px;text-align:center;"><?=20;?></th>
          <?php }else { ?>
          <th style="font-size:12px;text-align:center;"><?=0;?></th>
          <?php } ?>
          <th style="font-size:12px;text-align:right;"><?=$jml_total_2;?></th>
        </tr>
...
<table width="100%" rules="all" border="1" cellpadding="0" cellspacing="0" style="font-size:12px;">
  ...
  <tr>
    ...
    <td style="font-size:12px;text-align:center;"><?=$row_c->km_trayek;?></td>
    <td style="font-size:12px;text-align:center;"><?=20;?></td>
    <td style="font-size:12px;text-align:center;"><?=($row_c->km_trayek+20);?></td>
    <td style="font-size:12px;text-align:center;"><?=$row_c->rit;?></td>
    <td style="font-size:12px;text-align:right;"><?=($row_c->km_trayek+20)*$row_c->harga;?></td>
  </tr>
  <?php 
...
<tr>
  ...
  <th style="font-size:12px;text-align:center;"><?=$jml_km_3;?></th>
  <th style="font-size:12px;text-align:center;"><?=$jml_empty_3;?></th>
  <th style="font-size:12px;text-align:center;"><?=($jml_km_3+$jml_empty_3);?></th>
  <th style="font-size:12px;text-align:center;"><?=$jml_rit_3;?></th>
  <th style="font-size:12px;text-align:center;"><?=$jml_total_3;?></th>
</tr>
