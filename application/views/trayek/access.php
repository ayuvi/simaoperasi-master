	...
	<body class="sidebar-mini wysihtml5-supported <?= $this->config->item('color')?>">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<button class="btn btn-primary" onclick='ViewData(0)'>
										<i class='fa fa-plus'></i> Add Trayek Access
									</button>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<input type="hidden" id="id_trayek" name="id_trayek" value='<?= $id_trayek?>' />
													<input type="hidden" id="id_trayek_access" name="id_trayek_access" value='0' />
		...
		<script type='text/javascript'>
			var buTable = $('#buTable').DataTable({
				...
				ajax: 
				{
					url: "<?= base_url() ?>trayek/ax_data_trayek_access/<?= $id_trayek?>",
					type: 'POST'
				},
				columns: 
				[
					{
						data: "id_trayek_access", render: function(data, type, full, meta){
							var str = '';
			...
			$('#btnSave').on('click', function () {
				...
				{
					var url = '<?=base_url()?>trayek/ax_set_data_access';
					var data = {
						id_trayek: $('#id_trayek').val(),
						id_trayek_access: $('#id_trayek_access').val(),
						id_user: $('#id_user').val(),
						active: $('#active').val()
					};
					...
					$.ajax({
						...
						statusCode: {
					        500: function() {
					            alertify.alert("Warning","User Duplicate");
			...
			function ViewData(id_trayek_access)
			{
				if(id_trayek_access == 0)
				{
				...
				{
					var url = '<?=base_url()?>trayek/ax_get_data_access_by_id';
					var data = {
					...
					$.ajax({
						...
						$('#id_trayek_access').val(data['id_trayek_access']);
			...
			function DeleteData(id_trayek_access)
			{
				alertify.confirm(
					'Confirmation', 
					'Are you sure you want to delete this data?', 
					function(){
						var url = '<?=base_url()?>trayek/ax_unset_data_access';
						var data = {
							id_trayek_access: id_trayek_access
						};
