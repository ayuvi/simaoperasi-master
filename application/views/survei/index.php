				...
				[
					{
						data: "id_survei", render: function(data, type, full, meta){
							...
							str += '<li><a href="<?= base_url()?>survei/nilai/'+data+'"><i class="fa fa-check-square"></i> Set Penilaian</a></li>';
							str += '<li><a href="<?= base_url()?>survei/access/'+data+'"><i class="fa fa-group"></i> Access</a></li>';
							str += '<li><a href="<?= base_url()?>survei/analisa/'+data+'"><i class="fa fa-bar-chart"></i> Analisa</a></li>';
