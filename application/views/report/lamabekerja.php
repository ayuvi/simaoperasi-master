    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>
            Laporan Survei Berdasarkan Lama Bekerja
          </h1>
        </section>

        <section class="invoice">
          <div class="row">
		  <form action="<?= base_url()?>report/indexlamabekerja" method="post">
		  ...
		  <div class="form-group col-lg-2">
			<label>Lama Bekerja<br>Dari</label>
			...
			<label><br>Sampai</label>
				<select class="form-control" id="tahun2" name="tahun2">
					...
					<option value="100" > Ke atas</option>
				</select>
			</div>
...
// Build the chart
        ...
        // Set up the chart
            var chart = new Highcharts.Chart({
                ...
                title: {  
                    text: 'Laporan Grafik Berdasarkan Lama Bekerja'
                },
                subtitle: {
