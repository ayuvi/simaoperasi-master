	...
	<body class="sidebar-mini wysihtml5-supported <?= $this->config->item('color')?>">
						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading">
									...
									<div class="form-group col-md-4">
										<label>Komponen Penerimaan</label>
									...
									<div class="form-group col-md-2">
										...
										<button class="btn btn-info" onclick='cetakAk1()'>
		...
		<script type='text/javascript'>
			...
			function cetakNominatif(){
				...
				// } else {
					var url     = "<?= base_url() ?>report/cetakNominatif/";
					var id_divre = $('#id_divre').val();
					var id_bu = $('#id_bu').val();
					var format = $('#format').val();
					window.open(url+"?id_divre="+id_divre+"&id_bu="+id_bu+"&format="+format, '_blank');
					window.focus();
				// }	
			}
			...
			function cetakAk1(){
				if($('#id_segment').val() == '0') {
					...
					var url     = "<?= base_url() ?>report/laporan_ak1/";
