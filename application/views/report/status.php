    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>
            Laporan Survei Berdasarkan Status Pegawai
          </h1>
        </section>

        <section class="invoice">
          <div class="row">
		  <form action="<?= base_url()?>report/indexstatus" method="post">
		  ...
		  <div class="col-lg-12 col-xs-12"><br><br><br>
...
// Build the chart
        ...
        // Set up the chart
            var chart = new Highcharts.Chart({
                ...
                title: {  
                    text: 'Laporan Grafik Berdasarkan Status'
                },
                subtitle: {
