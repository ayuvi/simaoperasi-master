    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>
            Laporan Survei Berdasarkan Umur
          </h1>
        </section>

        <section class="invoice">
          <div class="row">
		  <form action="<?= base_url()?>report/indexumur" method="post">
		  ...
		  <div class="form-group col-lg-2">
			<label>Umur Pegawai<br>Dari</label>
				<select class="form-control" id="umur1" name="umur1">
			...
			<div class="form-group col-lg-2">
			<label><br>Sampai</label>
				<select class="form-control" id="umur2" name="umur2">
		  ...
		  <div class="row">
			...
			<div class="col-lg-12 col-xs-12"><br>
				<center><div id="report2" style="min-width: 310px; height: 400px; max-width: 1000px; margin: 0 auto"></div></center>
			</div>
		  </form>
		</section>
	  </div>
...
// Build the chart
        ...
        // Set up the chart
            var chart = new Highcharts.Chart({
                ...
                title: {  
                    text: 'Laporan Grafik Berdasarkan Umur'
                },
                subtitle: {
                    text: '<?php echo $status1;?> - <?php echo $status2;?> Tahun'
                },
                plotOptions: {
					pie: {
