    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>
            Laporan Survei Berdasarkan Jenis Kelamin
          </h1>
        </section>

        <section class="invoice">
          <div class="row">
		  <form action="<?= base_url()?>report/indexjeniskelamin" method="post">
...
// Build the chart
        ...
        // Set up the chart
            var chart = new Highcharts.Chart({
                ...
                title: {  
                    text: 'Laporan Grafik Berdasarkan Jenis Kelamin'
                },
                subtitle: {
                    text: '<?php if($status==1) echo 'Pria'; else echo 'Wanita'?>'
                },
                plotOptions: {
					pie: {
